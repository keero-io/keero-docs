...
The long-term goal is not to stop at a board. The goal is to turn this into a cute modular desktop pal with more personality, more interaction, and eventually more Tamagotchi-like behavior, while also learning from projects such as [MimicLaw](https://github.com/memovai/mimiclaw/tree/main).
